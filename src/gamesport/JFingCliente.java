 ...
 * @author santy
 */
public class JFingCliente extends javax.swing.JFrame {

  /**
   * Creates new form NJFingCliente
   */
  public JFingCliente() {
    initComponents();
  }
  ...
  public static void main(String args[]) {
    ...
    try {
      ...
      java.util.logging.Logger.getLogger(JFingCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    java.awt.EventQueue.invokeLater(new Runnable() {
      public void run() {
        new JFingCliente().setVisible(true);
      }
    });
  }
